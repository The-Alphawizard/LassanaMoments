...
import { Bell, MapPin, CircleUserRound } from "lucide-react";
import Work from "./Work";
import Reviews from "./Reviews";
import Profile from "../../../images/Photographer Dashboard-User Side-Images/profile.jpg"; //men
import Cover from "../../../images/Photographer Dashboard-User Side-Images/1.jpg"; // 1.jpg
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 mt-20">
          ...
          <div className="flex flex-col items-center gap-6 mt-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <button className="px-8 py-2.5 bg-blue-600 text-white rounded-full font-medium hover:bg-blue-700 transition-colors">
                Follow
              </button>
              <button className="px-6 py-2.5 bg-white border-2 border-gray-200 rounded-full font-medium hover:bg-gray-50 transition-colors flex items-center gap-2">
